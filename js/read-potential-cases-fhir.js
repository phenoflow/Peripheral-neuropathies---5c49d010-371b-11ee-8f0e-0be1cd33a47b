...
(async () => {
  ...
  await fs.writeFile("peripheral-neuropathies-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("peripheral-neuropathies-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
